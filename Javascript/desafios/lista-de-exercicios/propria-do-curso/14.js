/**
 * Crie uma estrutura condicional switch que receba uma string
 * com o nome de uma fruta e que possua três casos:
...
const qualAFruta = (fruta) => {
    switch (fruta) {
        ...
        case 'melancia':
            ...
            break
        default:
            console.log('Erro, Furta não encontrada')
    }
}
